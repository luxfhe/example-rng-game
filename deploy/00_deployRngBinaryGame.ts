import { checkExposedEncryptedVars } from "@luxfhe/hardhat-plugin";
import { DeployFunction } from "hardhat-deploy/types";
import { HardhatRuntimeEnvironment } from "hardhat/types";

/**
 * Deploys a contract named "RngBinaryGame" using the deployer account and
 * constructor arguments set to the deployer address
 *
 * @param hre HardhatRuntimeEnvironment object.
 */
const deployRngBinaryGame: DeployFunction = async function (
...
export default deployRngBinaryGame;

// Tags are useful if you have multiple deploy files and only want to run one of them.
// e.g. yarn deploy --tags RngBinaryGame
deployRngBinaryGame.tags = ["RngBinaryGame"];
